...
const SocialMedia: NextComponentType = () => (
    <div className="flex items-center justify-between fill-current space-x-8 text-carbon-500 md:space-x-20 lg:space-x-24">
        ...
        <SocialMediaIcon>
            <a target="blank" href="https://www.instagram.com/drown_the_sun/?hl=de">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <SocialMediaIcon>
            <a target="blank" href="https://open.spotify.com/artist/2yFB2TDFWStvT5nYj8g8Hc?si=ODHYkTPrTeCUb0Scrimzwg">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <SocialMediaIcon>
            <a target="blank" href="https://www.youtube.com/channel/UCLhT0cRde-LP89Va_jON7fA">
